        ...
        subir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (networkInfo != null && networkInfo.isConnected()){
                    ...
                    progressDialog.setTitle("Enviando registros");
                                ...
                                public void run() {
                                    ...
                                    client.post(PROCESAR_URL, params, new AsyncHttpResponseHandler() {
                                        ...
                                        public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                                            if (statusCode == 200) {
                                                Log.i("200", responseBody.toString());
                                                db.execSQL("DELETE FROM registros WHERE id ='" + id + "'");
                                                progressDialog.dismiss();
                                                Toast.makeText(getActivity().getApplicationContext(), "Datos enviados correctamente", Toast.LENGTH_SHORT).show();
                                                Fragment fragment_actual = new Listado_fragment();
