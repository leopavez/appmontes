...
public class DetalleRecuperarActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_recuperar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        myDB = new DatabaseHelper(DetalleRecuperarActivity.this);
    ...
    private void cargarDetalle(){
        try {
            ...
            Cursor cursor = db.rawQuery("SELECT reg.desde, reg.hasta, pro.razon_social, " +
                    "ta.name_envase, reg.cantidad FROM registros_recuperar reg " +
